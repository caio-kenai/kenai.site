...
export const journey: JourneyEntry[] = [
  {
    ...
    period: { pt: 'dez 2025 até hoje · tempo integral', en: 'Dec 2025 to present · full-time' },
    location: {
    ...
    current: true,
    description: {
      pt: 'Atuo predominantemente no setor de Desenvolvimento de Software. O suporte ficou restrito a demandas de alta complexidade, como conversões de bancos de dados e solicitações diretas da gestão. Meu foco atual é uma aplicação de inteligência artificial para radiodifusão, com automação de locuções, gestão de feeds RSS e clonagem de vozes para programação. Nela lidero a frente de front-end com TypeScript, React e Vite, com validação em Zod, estado e tabelas em TanStack Query e Table, e comunicação via Axios. Em paralelo atuo no back-end com C#, .NET e SQL, construindo CRUDs e integrando a aplicação ao ecossistema AWS da empresa.',
      en: 'I work mainly in the Software Development area. Support is now limited to high-complexity demands such as database conversions and requests coming straight from management. My current focus is an AI application for broadcasting, with voice-over automation, RSS feed management and voice cloning for programming. On it I lead the front-end with TypeScript, React and Vite, with Zod validation, state and tables through TanStack Query and Table, and data communication via Axios. In parallel I work on the back-end with C#, .NET and SQL, building CRUDs and integrating the application into the company AWS ecosystem.',
    },
    tags: [
      'TypeScript',
      'React',
  ...
  },
  {
    ...
    period: { pt: 'mar 2025 a dez 2025 · 10 meses', en: 'Mar 2025 to Dec 2025 · 10 months' },
    location: {
      pt: 'Ipatinga, Minas Gerais, Brasil · Presencial',
      en: 'Ipatinga, Minas Gerais, Brazil · On-site',
    },
    description: {
      pt: 'Atendi demandas do suporte técnico e do desenvolvimento, além de tarefas de vendas para entender o licenciamento dos produtos. No suporte, aprofundei análise técnica e diagnóstico em todas as aplicações da empresa, sejam locais, hospedadas ou em nuvem, com correções diretas em estrutura e dados, e em infraestrutura de redes, firewall, workgroups, segurança e compartilhamento. Evoluí em tecnologia de áudio, atendendo Playlist Digital e Aires Studio, e nos sistemas financeiros Smart Manager, Commercial e Planner. No desenvolvimento, corrigi bugs e implementei funcionalidades no Tocou 2.0, com front-end em Vue.js e TypeScript e back-end em C# e .NET sob arquitetura DDD, e construí toda a estrutura base do front-end de uma solução de IA com React e TypeScript. Também realizei conversões de bancos vindos de sistemas externos, com a documentação completa, e criei sistemas de IA com LangChain, LangGraph e CrewAI.',
      en: 'I handled demands from both technical support and development, plus sales tasks to understand product licensing. In support I deepened technical analysis and diagnostics across every company application, whether local, hosted or in the cloud, with direct fixes to structure and data, and in network infrastructure, firewall, workgroups, security and file sharing. I grew in audio technology, supporting Playlist Digital and Aires Studio, and in the financial systems Smart Manager, Commercial and Planner. In development I fixed bugs and shipped features on Tocou 2.0, with Vue.js and TypeScript on the front-end and C# and .NET under a DDD architecture on the back-end, and built the entire front-end foundation of an AI solution with React and TypeScript. I also carried out database conversions from external systems, with full documentation, and built AI systems with LangChain, LangGraph and CrewAI.',
    },
    tags: [
      'Vue.js',
      'TypeScript',
  ...
  },
  {
    ...
    period: { pt: 'Próximo passo', en: 'Next step' },
    current: true,
    description: {
  ...
  },
  {
    ...
    period: { pt: 'jan 2020 a mar 2025 · formado', en: 'Jan 2020 to Mar 2025 · graduated' },
    description: {
  ...
  },
  {
    ...
    title: {
      pt: 'Inglês fluente e nativo · English Language and Literature',
      en: 'Fluent and native English · English Language and Literature',
    },
    period: { pt: 'jan 2010 a abr 2017 · formado', en: 'Jan 2010 to Apr 2017 · graduated' },
    description: {
